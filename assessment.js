...
var primaryColors = ["yellow", "red", "blue", "green", "orange", "violet", "indigo"];
...
var doubleTheFun = function(par) {
  if(typeof par === "string" && isNaN(parseInt(par))) {
    par = par + par;
  }
  else if (isNaN(parseInt(par))) {
    par = parseInt(par) * 2;
  }
  else {
    par = par * 2;
